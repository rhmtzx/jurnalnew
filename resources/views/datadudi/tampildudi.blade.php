                    ...
                    <div class="breadcrumb-title pe-3">DATA DUDI</div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">EDIT DATA DUDI</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <h4><em>EDIT DATA DUDI</em></h4>
                                    <hr>
                        <form action="/updatedatadudi/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                ...
                                <input type="text" name="namadudi" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Nama DuDi" value="{{ $data->namadudi }}">
                                @error('namadudi')
                                ...
                                <input type="text" name="namakepdik" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Nama Kepala Direktur" value="{{$data->namakepdik}}">
                                @error('namakepdik')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="namadatapembimbing" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Nama Data Pembimbing" value="{{ $data->namadatapembimbing }}">
                                ...
                                <input type="text" name="alamatdudi" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Alamat DuDi" value="{{ $data->alamatdudi }}">
                                @error('alamatdudi')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="emaildudi" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Email DuDi" value="{{ $data->emaildudi }}">
                                    @error('emaildudi')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="persyaratan" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="Persyaratan" value="{{ $data->persyaratan }}">
                                        @error('persyaratan')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <input type="text" name="slotdudi" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="slotdudi" value="{{ $data->slotdudi }}">
                                        @error('slotdudi')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
