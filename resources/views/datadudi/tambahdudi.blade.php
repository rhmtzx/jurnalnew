                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Tambah Data Dudi</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Tambah Data Dudi</h5>
                                ...
                                <div class="mb-3">
                                    ...
                                    aria-describedby="emailHelp" placeholder="Masukkan Nama Dudi">
                                    @error('namadudi')
                                    ...
                                    <br>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label"><h6>Nama Kepala Direktur</h6></label>
                                        <input type="text" name="namakepdik" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Masukkan Nama Kepala Direktur">
                                        @error('namakepdik')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            aria-describedby="emailHelp" placeholder="Masukkan Alamat Dudi">
                                            @error('alamatdudi')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <br>
                                            <button type="submit" class="btn btn-primary">Submit Data Dudi</button>
                                            <a href="/datadudi" class="btn btn-danger mb-10">Kembali</a>
