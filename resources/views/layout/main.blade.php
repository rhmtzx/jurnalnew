...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    ...
    <script src="{{asset('velzon/cdn.datatables.net/buttons/2.2.2/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('velzon/cdn.datatables.net/buttons/2.2.2/js/buttons.print.min.js')}}"></script>
    <script src="{{asset('velzon/cdn.datatables.net/buttons/2.2.2/js/buttons.html5.min.js')}}"></script>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/dashboard-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:39:36 GMT -->
</html>
