            ...
            <div class="container">
                ...
                <div class="auth-box auth-sidebar">
                    <div id="loginform">
                        ...
                        <!-- Form -->
                        <div class="row">
                            <form class="col s12" action="/registerusermagang" method="POST">
                                @csrf
                                <!-- email -->
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="name" type="text" name="namakepdik"  class="validate" required>
                                        <label for="name">Nama Kepala Direktur</label>
                                    </div>
                                </div>
                                <!-- email -->
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="name" type="text" name="alamatdudi" class="validate" required>
                                        <label for="name">Alamat DUDI</label>
                                    </div>
                                </div>
                                <!-- pwd -->
                                <div class="row">
