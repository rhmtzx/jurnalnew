        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="main-services">
                    ...
                    <img src="{{ asset('landing/demo.epic-webdesign.com/tf-essentials/v1/images/main-service1.png') }}" class="width-100" alt="pic">
            ...
            <div class="col-md-4">
                ...
                <div class="main-services">
                    ...
                    <img src="{{ asset('landing/demo.epic-webdesign.com/tf-essentials/v1/images/main-service2.png') }}" class="width-100" alt="pic">

                    <h3>Marketers</h3>

                    <p>Curabitur quam etsum lacus netsum nulat iaculis ets vitae etsum nisle varius sed aliquam ets vitae netsum.</p>

                    <a href="#about" class="btn-blue-line small scrool">Essentials for Marketers</a>
            ...
            <div class="col-md-4">
                ...
                <div class="main-services">
                    ...
                    <a href="#about" class="btn-blue-line small scrool">Essentials for Agencies</a>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 wow slideInRight" data-wow-delay="0.25s" style="visibility: visible; animation-delay: 0.25s; animation-name: slideInRight;">
                ...
                <img src="{{ asset('landing/demo.epic-webdesign.com/tf-essentials/v1/images/img10.png') }}" class="width-100 box-shadow" alt="pic">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 margin-top-10">
                ...
                <img src="{{ asset('landing/demo.epic-webdesign.com/tf-essentials/v1/images/img4.jpg') }}" class="width-100 box-shadow" alt="picture">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img src="{{ asset('landing/demo.epic-webdesign.com/tf-essentials/v1/images/img0.png') }}" class="hero-image width-100 box-shadow" alt="pic">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p class="contact-info"><i class="fas fa-map-marker-alt"></i> 10 Oxford Street, London, UK, E1 1EC</p>

                <p class="contact-info"><i class="fas fa-envelope"></i> <a href="mailto:contact@youremail.com">office@essentials.co.uk</a></p>

                <p class="contact-info"><i class="fas fa-phone"></i> +44 987 654 321</p>
