                ...
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <h6 class="card-subtitle">Seluruh Data Kelas Sekolah Ada Disini!</h6>
                            <br>
                                ...
                                <table id="kelas" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/tampilkelas/{{ $row->id }}" class="btn btn-warning"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>
                                                <a href="#" class="btn btn-danger deletekelas" data-id="{{ $row->id }}"
...
<script>
    $('.deletekelas').click(function() {
        ...
        .then((willDelete) => {
            if (willDelete) {
                window.location = "/deletekelas/" + kategoriid + ""
