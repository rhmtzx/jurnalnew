                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <h4><em>TAMBAH KELAS</em></h4>
                                    ...
                                    <input type="text" name="kelassiswa" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Masukkan Kelas Siswa">
                                    @error('kelassiswa')
                                    ...
                                    <br>
                                    <br>
                                            <button type="submit" class="btn btn-primary">Submit Data Kelas</button>
                                            <a href="/datakelas" class="btn btn-danger mb-10">Kembali</a>
