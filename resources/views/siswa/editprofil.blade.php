                ...
                <div class="row">
                    ...
                    <form class="col s12" action="/updateprofildudi" method="POST">
                                        ...
                                        <label for="exampleFormControlInput1" class="form-label"><h6>Nama Kepala Direktur</h6></label>
                                            <input type="text" class="form-control" name="namakepdik" id="namakepdik" value="{{Auth()->user()->namakepdik}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="alamatdudi" id="alamatdudi" value="{{Auth()->user()->alamatdudi}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="notelepondudi" id="notelepondudi" value="{{Auth()->user()->notelepondudi}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="kd_dudi" id="kd_dudi" value="{{Auth()->user()->kd_dudi}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <form class="col s12" action="/updateprofilguru" method="POST">
                                        ...
                                        <label for="exampleFormControlInput1" class="form-label"><h6>NIP Guru</h6></label>
                                            <input type="number" class="form-control" name="nip" id="nip" value="{{Auth()->user()->nip}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="notlpn" id="notlpn" value="{{Auth()->user()->notlpn}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="kd_guru" id="kd_guru" value="{{Auth()->user()->kd_guru}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <label for="exampleFormControlInput1" class="form-label"><h6>NIS Siswa</h6></label>
                                            <input type="number" class="form-control" name="nissiswa" id="nissiswa" value="{{Auth()->user()->nissiswa}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="alamatsiswa" id="alamatsiswa" value="{{Auth()->user()->alamatsiswa}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="notlpsiswa" id="notlpsiswa" value="{{Auth()->user()->notlpsiswa}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="id_jurusan" id="id_jurusan" value="{{Auth()->user()->id_jurusan}}">
                                            <div class="invalid-feedback">
                                                Please enter email
                                            </div>
                                        </div> -->
