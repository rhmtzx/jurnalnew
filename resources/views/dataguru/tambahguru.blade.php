                            ...
                            <div class="card-content">
                                ...
                                <h4><em>TAMBAH GURU</em></h4>
                                        ...
                                        <form action="/insertdataguru" method="POST" enctype="multipart\form-data" >
                                            ...
                                            aria-describedby="emailHelp" placeholder="Masukkan NIP">
                                            @error('nip')
                                            ...
                                            aria-describedby="emailHelp" placeholder="Masukkan Nama Guru">
                                            @error('namaguru')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                            ...
                                            aria-describedby="emailHelp" placeholder="Masukkan Alamat Guru">
                                            @error('alamat')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                            ...
                                            aria-describedby="emailHelp" placeholder="Masukkan No Telepon Guru">
                                            @error('notlpn')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                            ...
                                            <br>
                                            <br>
                                            <button type="submit" class="btn btn-primary">Submit Data Guru</button>
                                            <a href="/dataguru" class="btn btn-danger mb-10">Kembali</a>
