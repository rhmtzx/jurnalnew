                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="card">
                                        <div  class="card-body">
                                            <h2 class="text-center mb-4">TAMBAH DATA JURUSAN</h2>
                                            <br>
                                            <form action="/insertjurusan" method="POST" enctype="multipart\form-data" >
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="namajurusan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Isi Jurusan">
                                                </div>
                                                @error('namajurusan')
