                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Data Jurnal Page</li>
                                    </ol>
                                </div>
                      ...
                      @foreach ($datar as $rowr )
                        ...
                        <div class="col-sm-6 col-xl-3" >
                            ...
                            <div class="card" style="">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title mb-2 text-center">{{ $rowr->namajurusan }}</h4>
                                    <br>
                                    <p class="card-text text-center">Data Jurnal Kelas {{ $rowr->namajurusan }}</p>
                                    <div class="text-center">
                                        <br>
                                        <a href="/data/{{ $rowr->id }}" class="btn btn-info">Detail</a>
                                    </div>
                                </div>
                                </div>
