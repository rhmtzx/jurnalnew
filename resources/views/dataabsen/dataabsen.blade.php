                ...
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            <h1 class="card-title">Data Absen Siswa</h1>
                            <h6 class="card-subtitle">Seluruh Data Absen Siswa Sekolah Ada Disini!</h6>
                            <br>
                            <a href="/tambahabsen" class="btn btn-success mb-10">Tambah Absen +</a>
                            <br>
                            <br>
