                                ...
                                <h4><em>TAMBAH ABSEN</em></h4>
                                        ...
                                        <form action="/insertabsen" method="POST" enctype="multipart\form-data" >
                                            ...
                                            <label for="exampleInputEmail1" class="form-label"><h6>Keterangan</h6></label>
                                                <input type="text" name="keterangan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Isi Keterangan">
                                            </div>
                                            @error('keterangan')
                                            ...
                                            <label for="exampleInputEmail1" class="form-label"><h6>Status Jurnal</h6></label>
                                                <input type="text" name="statusjurnal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Isi Status Jurnal">
                                            </div>
                                            @error('statusjurnal')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <label for="exampleInputEmail1" class="form-label">
                                                <h6>Masukkan Foto Keterangan</h6>
                                            ...
                                            <br>
                                            <br>
                                                <h6>" Info : Abaikan Jika Tidak Sakit/Izin "</h6>
