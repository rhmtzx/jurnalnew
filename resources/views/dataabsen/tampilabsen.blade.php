                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Update Absen Page</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Data Siswa</a></li>
                                        <li class="breadcrumb-item active">Update Absen</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Update Absen</h5>
                                ...
                                <form action="/updateabsen/{{ $data->id }}" method="POST" enctype="multipart\form-data" >
                                            ...
                                            <label for="exampleInputEmail1" class="form-label"><h6>Status Jurnal</h6></label>
                                                <input type="text" name="statusjurnal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Isi Status Jurnal" value="{{$data->statusjurnal}}">
                                            </div>
                                            @error('statusjurnal')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
