                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="mb-3">
                                    ...
                                    aria-describedby="emailHelp" placeholder="Masukkan Nis Siswa">
                                    @error('nissiswa')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        aria-describedby="emailHelp" placeholder="Masukkan Nama Siswa">
                                        @error('namasiswa')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    aria-describedby="emailHelp" placeholder="Masukkan Alamat Siswa">
                                                    @error('alamatsiswa')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        aria-describedby="emailHelp" placeholder="Masukkan No Telepon Siswa">
                                                        @error('notlpsiswa')
                                                        <div class="text-danger">
                                                            {{ $message }}
                                                        </div>
