                    ...
                    <div class="breadcrumb-title pe-3">DATA DUDI</div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">EDIT DATA PERSYARATAN</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <h4><em>EDIT DATA PERSYARATAN</em></h4>
                                    <hr>
                        <form action="/updatedatapersyaratan/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                ...
                                <input type="text" name="deskripsi" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Deskripsi" value="{{$data->deskripsi}}">
                                @error('deskripsi')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                                ...
                                <br>
                                        ...
                                        <div class="mb-1">
                                                ...
                                                <br><img class="img mb-3"src="{{ asset('fotodudi/' . $data->fotopersyaratan) }}"
