...
<body>
        <div class="page-content-wrapper">
          <div class="justify-content-center">
            <div class="row-2">
              ...
                          <hr>
                                    <a href="/tambahpersyaratan" class="btn btn-success mb-3">Tambah Persyaratan +</i></a>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    <th scope="row">{{ $no++ }}</th>
                                                    <td>
                                                        <img src="{{ asset('fotodudi/' . $row->filepersyaratan) }}" alt=""
                                                            style="width: 40px">
                                                    </td>
                                                    <td>{{ $row->deskripsi }}</td>
                                                    <td>{{ $row->id_dudi }}</td>
                                                    ...
                                                    <td scope="row">
                                                        <a href="/tampilpersyaratan/{{ $row->id }}"
                                                            class="btn btn-warning"><i
                                                                class="fa-sharp fa-solid fa-pen-to-square"></i></a>
                                                        <a href="#" class="btn btn-danger deletepersyaratan"
                                                            data-id="{{ $row->id }}"
    ...
    <script>
        $('.deletepersyaratan').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletepersyaratan/" + pegawaiid + ""
