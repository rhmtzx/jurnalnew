                    ...
                    <div class="col s12">
                        <div class="card">
                            <div class="card-content">
                                <h1 class="card-title">Data Persyaratan</h1>
                                <h6 class="card-subtitle">Seluruh Data Persyaratan Dudi Ada Disini!</h6>
                                <br>
                                <a href="/tambahdatapersyaratan" class="btn btn-success mb-10">Tambah Persyaratan +</a>
                                <br>
