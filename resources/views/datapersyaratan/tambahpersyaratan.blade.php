                    ...
                    <div class="breadcrumb-title pe-3">DATA DUDI</div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">TAMBAH PERSYARATAN</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <h4><em>TAMBAH PERSYARATAN</em></h4>
                                    <hr>
                            <form action="/insertdatapersyaratan" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <br>
                                    <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Deskripsi Persyaratan</label>
                                    <input type="text" name="deskripsi" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Deskripsi">
                                    @error('deskripsi')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
                                    @enderror
                                            <br>
                                            <div class="mb-1">
                                                    <label for="exampleInputEmail1" class="form-label">Masukkan Foto Persyaratan</label>
                                                    <input type="file" name="fotopersyaratan" class="form-control">
                                                </div>
                                                <div class="mt-4">
